        ...
        <div className="relative z-10 max-w-lg">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 border-t border-white/10 pt-8">
            <div>
              ...
              <p className="mt-1 font-body text-xs text-white/60">Verified Partners</p>
            </div>
            <div>
              <p className="font-heading font-black text-2xl text-accent-orange">25+</p>
              <p className="mt-1 font-body text-xs text-white/60">Cities Covered</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="flex flex-col justify-center p-6 sm:p-12 lg:p-16">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="mb-10 text-center lg:text-left">
            <Badge variant="info" className="bg-accent-orange/5 border-none text-accent-orange shadow-none mb-4 inline-flex">
          ...
          <div className="flex bg-neutral-200/50 rounded-xl p-1 mb-8">
            <button
              className={`flex-1 py-2.5 text-sm font-semibold rounded-lg transition-all duration-200 ${
                loginMethod === "phone" ? "bg-white text-accent-orange shadow-sm" : "text-neutral-text-muted hover:text-neutral-text-dark"
              }`}
            ...
            <button
              className={`flex-1 py-2.5 text-sm font-semibold rounded-lg transition-all duration-200 ${
                loginMethod === "email" ? "bg-white text-accent-orange shadow-sm" : "text-neutral-text-muted hover:text-neutral-text-dark"
              }`}
              ...
              {step === 1 ? (
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-5">
                  <div className="text-center lg:text-left mb-4">
                    ...
                    <button type="button" onClick={() => setStep(1)} className="text-xs font-semibold text-accent-orange hover:underline mt-1">Change Number</button>
                  </div>
                  <Input
