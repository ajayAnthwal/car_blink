    ...
    <div className="flex flex-col gap-1.5 w-full text-left">
      ...
      <div className="relative">
        ...
        <input
          id={inputId}
          ref={ref}
          className={`w-full ${icon ? "pl-11" : "pl-4"} pr-4 py-3 bg-white border rounded-xl font-body text-sm text-neutral-text-dark placeholder:text-neutral-text-muted/60 focus:outline-none focus:ring-1 transition-colors ${
            error
